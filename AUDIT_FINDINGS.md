...
- **Modals didn't lock background scroll** — the hours sheet (TenantView) and the hour-picker sheet (BookingFlow) let the page scroll behind them on mobile. Added a body scroll-lock while each is open.
